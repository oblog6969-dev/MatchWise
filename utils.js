...
const TRANSLATIONS = {
    en: {
        ...
        import_btn_code: "Import Code",
        saved_profiles_heading: "Saved Profiles",
        saved_profiles_desc: "Select 1 profile to view or 2 profiles to compare.",
        compare_btn_text: "Compare / View Selected",
        export_profiles: "Export Profiles",
        print_pdf: "Print / Export PDF",
        export_all: "Export All Backup",
        gender: "Gender",
        gender_male: "Male",
    ...
    ar: {
        ...
        import_code_title: "استيراد من رمز المشاركة",
        ...
        strengths: "نقاط القوة والانسجام الجوهري",
        challenges: "التحديات المحتملة ومواضع الحذر",
        discussion_topics: "محاور للنقاش المشترك",
        deal_breakers: "تنبيهات الخطوط الحمراء الحساسة",
        growth_opps: "فرص النمو والارتقاء بالعلاقة",
        recommendations: "التوصيات النفسية والإرشادية",
